...
Start_potential=1.31;
End_potential=1.48;

%convert population to coverage, using maximum of Pop1 as upper bound.
Max_Pop=3.66E16; %maximum from redox 2, subtract background of redox 2 at very low potential(3.77-0.11=3.66)
Theta=Pop./Max_Pop;
...
csvwrite(sprintf('%s_frumkin_fit_coverage_data_E0=%d r=%d R=%d.csv',filename,E0,r,R_sqaure),[Potential_cut,Theta_cut]);
