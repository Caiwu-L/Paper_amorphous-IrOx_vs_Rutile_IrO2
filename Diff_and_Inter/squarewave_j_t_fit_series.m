...
filename1='current-0.4-_0.42.txt';
filename2='current-0.4-_0.44.txt';
filename3='current-0.4-_0.46.txt';
filename4='current-0.4-_0.48.txt';
filename5='current-0.4-_0.50.txt';
filename6='current-0.4-_0.52.txt';
filename7='current-0.4-_0.54.txt';
%filename8='current-minus0.05-_0.27.txt';
...
start=50;
final=980; % data size you want to plot (check size of original data to make sure all the data have the same size and can be written in one excel)
format long;
J_t_new=[];
max_charge_array=[];
