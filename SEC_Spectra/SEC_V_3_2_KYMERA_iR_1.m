...
RHE_conv_factor=0;
iR=31.7;%input R obtain in EIS, put 0 if no need iR correct.
iR_compen=1; %input iR compensation percentage
smoothing_weight=100;
WL_max=845;
WL_min=440;
filename1='IrOx_2nm_2s_interval_2SEC';
filename2='WL_50nm';
filename3='IrOx_2nm_2s_interval_2_JV';
...
tite=strcat('Spectrum vs 0.64',' V Ag/AgCl' );
figure
...
fileN=strcat(filename1,'DOD_',num2str(iR),'ohm.csv');
fileNS=strcat(filename1,'DOD_',num2str(iR),'ohm_smooth',num2str(smoothing_weight),'.csv');
